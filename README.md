...
Development: Node.js 24.15+. In backend run `npm ci && npm run dev`. In frontend run `npm ci && npm run dev`. Open http://localhost:5173. The backend defaults to localhost:4003 and stores private data under backend/.data.
